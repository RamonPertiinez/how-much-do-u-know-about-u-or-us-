(() => {
  ...
  const DEFAULT_CHALLENGES = [
    ...
    },
    {
      ...
      type: "audio",
      emoji: "🎵",
      src: "assets/audio/intro.mp3", // si no existeix, el navegador simplement no reproduirà
    ...
    },
    {
      ...
      type: "image-guess",
      emoji: "🖼️",
      src: "assets/images/sample.jpg", // si no existeix, es veurà el 'broken image', però la prova funciona igual
...
setupRiddleUI();
  ...
  function openChallenge(id) {
    ...
    // Aplica la teva lletra només als moments especials (títols de prova si vols)
